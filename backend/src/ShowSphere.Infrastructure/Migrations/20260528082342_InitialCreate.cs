...
namespace ShowSphere.Infrastructure.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "MovieNotificationSubscriptions",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MovieNotificationSubscriptions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MovieNotificationSubscriptions_Movies_MovieId",
                        column: x => x.MovieId,
                        principalTable: "Movies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MovieNotificationSubscriptions_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MovieNotificationSubscriptions_MovieId",
                table: "MovieNotificationSubscriptions",
                column: "MovieId");

            migrationBuilder.CreateIndex(
                name: "IX_MovieNotificationSubscriptions_UserId_MovieId",
                table: "MovieNotificationSubscriptions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_UserId_MovieId",
                table: "Wishlists",
                columns: new[] { "UserId", "MovieId" },
                unique: true);
        }
